...
2. Generate analysis conclusion report in the end`, workspaceRoot)
...
3. When observation with Error, review and fix it.`
	...
	// 配置工具（数据分析 Agent 使用 PythonExecute, FileSaver, StrReplaceEditor, VisualizationPrepare, DataVisualization）
	...
	agent.Description = "An analytical agent that utilizes python and data visualization tools to solve diverse data analysis tasks"
	agent.MaxSteps = 20
